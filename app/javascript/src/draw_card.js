(function() {
  //$(document).on("draw_card", ".playing_card", function(e){
  window.draw_card = function(card){
    //var card = $(e.target);
    draw_card(card);
  };

  $(document).on("card_handler_clear_bottom", function(){
    $(document).find(".table-card-0").each(function(i, canvas){
